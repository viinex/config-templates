...
$(JSONS): %.json: %.yaml $(JSONNETS)
	...
	jsonnet --ext-str CID=${CID} --ext-str-file confYaml=sample-acp-uz.yaml main-acp-uz.jsonnet --ext-str OSName=${OSName} --ext-str deploy=systemd --ext-str-file def=acp-uz-defaults.yaml -o sample-acp-uz.json
